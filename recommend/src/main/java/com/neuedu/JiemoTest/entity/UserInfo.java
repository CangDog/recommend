...
public class UserInfo {
	...
	public String toString() {
		return "UserInfo [userid=" + userid + ", username=" + username + ", password=" + password + ", bonuspoints="
				+ bonuspoints + ", phonenumber=" + phonenumber + ", email=" + email + ", introduction=" + introduction
				+ ", affiliated=" + affiliated + ", nickname=" + nickname + ", usertype=" + usertype + ", spare1="
				+ spare1 + ", spare2=" + spare2 + ", spare3=" + spare3 + ", spare4=" + spare4 + "]";
	}
}